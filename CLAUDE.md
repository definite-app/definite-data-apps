...
examples/{slug}/
  ...
  src/App.tsx               <-- your UI code
  src/definite-runtime.tsx  <-- runtime library (don't edit, copied from runtime/)
...
This copies `templates/blank/` to `examples/my-app/` and copies `runtime/definite-runtime.tsx` into its `src/` directory.
...
- Do NOT edit `src/main.tsx` or `src/definite-runtime.tsx`.
...
Exported from `src/definite-runtime.tsx`:
